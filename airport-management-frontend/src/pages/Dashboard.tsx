...
const Dashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      setRecentFlights([
        { flight_number: "AI101", departure_airport_id: "BLR", arrival_airport_id: "DEL", departure_time: "10:30", status: "boarding", available_seats: 45 },
        { flight_number: "6E202", departure_airport_id: "DEL", arrival_airport_id: "BOM", departure_time: "11:15", status: "scheduled", available_seats: 120 },
      ]);
    } finally {
      setLoading(false);
    }
